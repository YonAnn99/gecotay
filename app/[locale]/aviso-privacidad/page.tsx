...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Cómo Grupo Ecotay trata tus datos personales, conforme a la LFPDPPP.",
  },
  twitter: {
    ...TWITTER_BASE,
    title: "Aviso de privacidad | Grupo Ecotay",
    description: "Cómo Grupo Ecotay trata tus datos personales.",
  },
  alternates: {
...
const direccionOficial =
  "Cerrada San Luis Potosí Mz. 2 Lt. 2, Col. Santa María Tulpetlac, Ecatepec de Morelos, Estado de México, C.P. 55400";
...
const secciones = [
  ...
  },
  {
    ...
    contenido: [
      ...
      "Los correos electrónicos incluyen vínculos que permiten a GRUPO ECOTAY saber si usted activó dicho vínculo y visitó la página web de destino, pudiendo esta información ser incluida en su perfil.",
      "En caso de que usted prefiera que GRUPO ECOTAY no recolecte información sobre su interacción con dichos vínculos, puede optar por modificar el formato de las comunicaciones (por ejemplo, recibir el mensaje en texto y no en formato HTML) o hacer caso omiso del vínculo y no acceder a su contenido.",
  ...
  },
  {
    ...
    contenido: [
      "El Titular tiene, en todo momento, derecho de acceder, rectificar y cancelar sus datos personales, así como de oponerse al tratamiento de los mismos o revocar el consentimiento, presentando una solicitud con la información y documentación siguiente:",
      "Nombre del Titular, domicilio, teléfono y dirección de correo electrónico.",
      "Los documentos que acrediten su identidad (copia simple en formato impreso o electrónico de su credencial de elector, cédula profesional, pasaporte o forma migratoria) o, en su caso, la representación legal del Titular (carta poder simple con firma autógrafa del Titular, del mandatario y sus correspondientes identificaciones).",
      ...
      "En las solicitudes de rectificación, el Titular deberá indicar las modificaciones a realizarse y aportar la documentación que sustente su petición.",
      "El Responsable responderá en un plazo máximo de veinte días hábiles contados desde la recepción de la solicitud; los plazos podrán ser ampliados solo en términos de la LFPDP.",
      "La entrega de los Datos Personales será gratuita; solo se cubrirán los gastos justificados de envío o el costo de reproducción en copias u otros formatos. Si el Titular reitera su solicitud en un periodo menor a doce meses, deberá cubrir los costos correspondientes equivalentes a 1.5 días de Salario Mínimo Vigente en la Ciudad de México, a menos que existan modificaciones sustanciales al Aviso de privacidad que motiven nuevas consultas.",
      "Para las solicitudes de cancelación se estará a lo dispuesto en el Artículo 26 de la LFPDP, incluyendo los casos de excepción de cancelación ahí señalados.",
      "La presentación de una solicitud de oposición del uso de Datos Personales dará al Responsable la facultad de oponerse al uso de los Datos Personales que el Titular haya entregado al oponente.",
    ],
  },
  {
    ...
    <>
      <section className="pt-28 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-primary/5 to-transparent">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 [text-shadow:0_1px_3px_rgba(0,0,0,0.85),0_2px_12px_rgba(0,0,0,0.55)]">
            ...
            personal recopilada sobre el Titular por {EMPRESA.nombre} en su carácter de Responsable.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-10">
          {secciones.map((s) => (
            <div key={s.titulo}>
              <h2 className="text-2xl font-semibold text-gray-100 [text-shadow:0_1px_3px_rgba(0,0,0,0.9),0_2px_14px_rgba(0,0,0,0.6)] mb-4">{s.titulo}</h2>
              <ul className="space-y-3 text-gray-300 [text-shadow:0_1px_3px_rgba(0,0,0,0.85),0_2px_12px_rgba(0,0,0,0.55)] leading-relaxed">
          ...
          <div className="p-6 bg-primary/5 border border-primary/20 rounded-2xl text-sm text-gray-300 [text-shadow:0_1px_3px_rgba(0,0,0,0.85),0_2px_12px_rgba(0,0,0,0.55)]">
            <p className="font-semibold text-gray-100 [text-shadow:0_1px_3px_rgba(0,0,0,0.9),0_2px_14px_rgba(0,0,0,0.6)] mb-2">Última actualización</p>
            <p>Agosto 2026</p>
            <p className="mt-2">
              Este Aviso de privacidad puede actualizarse periódicamente en www.gecotay.com. Para cualquier
              duda, contacta a {CONTACTO.correos.quejas} o {CONTACTO.correos.allservice}.
            </p>
          </div>
        </div>
      </section>
