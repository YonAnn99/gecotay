...
// CircularGallery — WebGL circular/coverflow gallery (ogl-powered).
// Adapted from the reactbits.dev "Circular Gallery" component for use as a
// Next.js client component. The internal renderer classes intentionally use
