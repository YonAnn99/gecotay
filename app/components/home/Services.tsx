...
const services = [
  {
    ...
    description: "Creamos mobiliario adaptado a tus espacios, necesidades y identidad de marca.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    description: "Control total de calidad en nuestra fábrica con materiales certificados y procesos sostenibles.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  },
  {
    ...
    description: "Productos que cumplen normativas UNE-EN 1335 y promueven la salud laboral.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    description: "Gestión integral de proyectos para oficinas, hoteles, espacios públicos y colectividades.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    description: "Servicio técnico, repuestos y garantía extendida para alargar la vida de tu inversión.",
  },
];
