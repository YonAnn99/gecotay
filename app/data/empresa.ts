...
export const SERVICIOS = [
  ...
  },
  {
    ...
    titulo: "Transporte",
    descripcion:
      "Grupo Ecotay, como su nombre lo indica, es un grupo de empresas de diferentes sectores; ofertamos el servicio de mudanzas y traslados de mercancías, así como reubicaciones de mobiliario.",
